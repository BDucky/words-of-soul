...
export default async function AdminDashboardPage({ searchParams }: Props) {
  ...
  return (
    <AdminPageShell className="flex flex-col gap-8 lg:gap-16 min-h-screen">
      ...
      <section className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="font-sans text-base sm:text-lg text-secondary max-w-lg leading-relaxed">
        ...
        <div className="relative sm:shrink-0">
          <input
            ...
            className="font-sans text-sm bg-surface-container-low border border-outline-variant/40 rounded-lg pl-4 pr-10 py-2.5 w-full sm:w-60 text-on-surface placeholder:text-outline/50 focus:outline-none focus:border-primary transition-colors"
          />
      ...
      {/* ── Pagination ── */}
      <AdminPagination currentPage={safePage} totalPages={totalPages} baseHref="/dashboard" />
