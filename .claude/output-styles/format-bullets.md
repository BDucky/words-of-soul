...
- File Analysis Results
  - Apps found
    - apps/designer: Design editor application
      - Vue 3 + Composition API
      - Pinia stores for state
    - apps/enduser: End user application
    - apps/auth: Authentication flows
  - Packages structure
    - packages/core: Shared utilities and types
    - packages/editor: Canvas and editing tools
    - packages/plugins: GraphQL operations
