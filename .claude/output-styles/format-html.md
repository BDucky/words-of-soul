...
description: Format responses as semantic HTML within the conversation (no file generation)
---
...
<article>
  ...
  <main>
    <section data-type="success">
      ...
      <ul>
        <li data-file="apps/designer/src/components/Editor.vue" data-action="edit">Updated composition API setup</li>
        <li data-file="packages/core/src/utils/canvas.ts" data-action="edit">Added helper functions</li>
      </ul>
    </section>
    <section>
      <h3>Code Changes</h3>
      <pre><code class="language-typescript" data-file="packages/core/src/utils/canvas.ts" data-line="15-25">
export function calculateBounds(element: CanvasElement): Bounds {
  return {
    x: element.left,
    y: element.top,
    width: element.width,
