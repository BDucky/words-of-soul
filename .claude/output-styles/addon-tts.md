...
USER_NAME, I've refactored the Editor component to use composition API and all tests are passing.

```bash
uv run .claude/hooks/utils/tts/elevenlabs_tts.py "USER_NAME, I've refactored the Editor component to use composition API and all tests are passing."
```
